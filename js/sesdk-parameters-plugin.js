    ...
    JSSDK.extend({
      parameters: {
        init: function init(remoteConfig) {
          ...
          cacheOnlineConfig.defaultConfig = JSSDK.Storage.getItem(storageKey$1["default"], true, []); // 校验本地存储的combinationId是否有效
        ...
        requestRetry: function requestRetry(resolve, requestData, flag, sdkReportData, retryCount) {
          ...
          if (retryCount === void 0) {
            retryCount = JSSDK.settingData.ruleRetryTimes;
          }

          JSSDK.HttpHelper.post("//" + JSSDK.settingData.ruleDomain + "/rule/config/get", requestData, {
            timeout: JSSDK.settingData.ruleTimeout * 1000
          }).then(function (res) {
            ...
            if (retryCount > 0) {
              ...
              resolve({
                retryCount: JSSDK.settingData.ruleRetryTimes - retryCount,
        ...
        setTimer: function setTimer() {
          ...
          }, JSSDK.settingData.ruleInterval * 1000);
        },
